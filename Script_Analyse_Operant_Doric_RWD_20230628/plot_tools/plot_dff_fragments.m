function fig = plot_dff_fragments(step1, step2)

    i1 = step2.i1;
    i2 = step2.i2;
    D = step2.D;
    x = step2.x;
    mean_frag_raw = step2.dff_PETA.matrix_mean;
    std_frag_raw = step2.dff_PETA.matrix_std;
    mean_frag_zscore = step2.dff_PETA.z_mean;
    std_frag_zscore = step2.dff_PETA.z_std;
    zscored = step2.dff_PETA.zscored_matrix;
    ...
    plot(step1.time,step1.dff, 'color', [125, 125, 125]/255);
    for j=1:n
